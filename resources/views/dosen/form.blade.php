...
<div class="row mb-3">
    ...
    <div class="col-md-4">
        <input type="text" name="nid" id="nid" class="form-control @error('nid') is-invalid @enderror" value="{{ old('nid') ?? $dosen->nid ?? '' }}" autofocus placeholder="8 digit angka NID, contoh: 12345678">
        @error('nid')
...
{{-- hidden form --}}
@isset($dosen)
    <input type="hidden" name="temp_url" value="{{ old('temp_url') ?? url()->previous(). '#row-'.$dosen->id }}">
@else
