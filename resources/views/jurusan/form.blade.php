...
<div class="row mb-3">
    <label for="daya_tampung" name="daya_tampung" class="col-md-3 col-form-label text-md-end">Daya Tampung Jurusan</label>
    <div class="col-md-4">
        <input type="text" name="daya_tampung" id="daya_tampung" class="form-control w-25 @error('daya_tampung') is-invalid @enderror" value="{{ old('daya_tampung') ?? $jurusan->daya_tampung ?? '' }}" autofocus>
        @error('daya_tampung')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
