            ...
            <div class="col-10 offset-1">
                ...
                <div class="input-group mb-3">
                    <select name="kategori" id="kategori" class="form-select w-10">
                        ...
                        <option value="matakuliah" {{ ($kategori ?? '') == 'matakuliah' ? 'selected': '' }}>Matakuliah</option>
                    </select>
                    <input type="text" name="s" id="s" value="{{ $s ?? '' }}" class="form-control w-50" placeholder="Nama Dosen / Mahasiswa / Mata Kuliah">
                                ...
                                <tr>
                                    ...
                                    @elseif ($kategori == 'matakuliah')
                                        ...
                                        <tr>
                                            <th>{{ $loop->iteration }}</th>
                                            <td>
                                                <a href="{{ route('matakuliahs.show', ['matakuliah' => $matakuliah->id]) }}">{{ $matakuliah->nama }} ({{ $dosen->kode }})</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    @endif
